...
export const EL_CATEGORIES: Record<ELCategory, ELCategoryConfig> = {
  PLANEJAR: {
    ...
    shortLabel: 'Planejar',
    icon: 'ClipboardList',
    description: 'Estruturas voltadas a organizar, priorizar e planejar o portfólio ou os próximos passos de uma iniciativa.',
  ...
  DAR_PEDIR_AJUDA: {
    ...
    icon: 'HandHeart',
    description: 'Estruturas de consultoria entre pares, apoio mútuo e pedidos/ofertas de ajuda entre pessoas ou equipes.',
  ...
  ANALISAR_DIAGNOSTICAR_REFLETIR: {
    ...
    icon: 'Search',
    description: 'Estruturas para diagnosticar causas, revelar padrões ocultos e refletir sobre a situação atual.',
    en: { label: 'Analyze, Diagnose or Reflect', shortLabel: 'Analyze/Reflect' },
    es: { label: 'Analizar, Diagnosticar o Reflexionar', shortLabel: 'Analizar/Reflexionar' },
  },
  REVELAR_GERAR_MELHORAR: {
    label: 'Revelar, Gerar, Melhorar Ideias ou Soluções',
    shortLabel: 'Gerar/Melhorar',
    icon: 'Sparkles',
    description: 'Estruturas para gerar, revelar ou aperfeiçoar ideias, protótipos e soluções novas.',
    en: { label: 'Reveal, Generate or Improve Ideas/Solutions', shortLabel: 'Generate/Improve' },
    es: { label: 'Revelar, Generar o Mejorar Ideas/Soluciones', shortLabel: 'Generar/Mejorar' },
  },
  COMPARTILHAR_DISSEMINAR: {
    label: 'Compartilhar ou Disseminar Ideias',
    shortLabel: 'Compartilhar',
    icon: 'Share2',
    description: 'Estruturas para conectar pessoas e disseminar rapidamente ideias, experiências ou boas práticas.',
  ...
  DESENVOLVER_ESTRATEGIAS: {
    ...
    icon: 'Target',
    description: 'Estruturas voltadas a propósito, governança e construção de estratégias de médio/longo prazo.',

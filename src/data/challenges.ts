...
export const ALL_CHALLENGES: Challenge[] = [
  ...
  // Desafio 1
  {
    ...
    bestChoiceName: 'TRIZ (Destruição Criativa e Desapego)',
    ...
    stringSequence: 'TRIZ ➔ Ecocycle Planning',
  ...
  // Desafio 2
  {
    ...
    bestChoiceName: '15% Solutions (Soluções a 15%)',
    ...
    inStringRole: 'Depois do Ecocycle Planning (Ativação de autonomia imediata)',
    stringSequence: 'Ecocycle Planning ➔ 15% Solutions',
  ...
  // Desafio 3
  {
    id: 3,
    level: 'PADAWAN',
    title: 'String: Debriefing Reflexivo do Ecociclo',
    ...
    inStringRole: 'Depois do Ecocycle Planning (Fechamento reflexivo e plano de ação)',
    stringSequence: 'Ecocycle Planning ➔ What, So What, Now What?',
    anotherPossibility: '15% Solutions (#5) pode suceder o W3 para transformar as conclusões do "E agora?" em compromissos individuais imediatos.',
    ecocyclePhase: 'Integração de todo o Ecociclo',
    explanation: 'What, So What, Now What? (#11) é uma escolha muito sólida para fechar sessões com o Ecocycle Planning, pois impede que o grupo pule direto para soluções simplistas antes de analisar criticamente o panorama geral.'
  },
  ...
  // Desafio 4
  {
    ...
    bestChoiceName: 'Impromptu Networking (Conexão Rápida em Pares)',
    ...
    stringSequence: 'Impromptu Networking ➔ Ecocycle Planning',
  ...
  // Desafio 5
  {
    id: 5,
    level: 'PADAWAN',
    title: 'String: Ampliando a Participação Total no Ecociclo',
    ...
    bestChoiceName: '1-2-4-All (1-2-4-Todos)',
    ...
    inStringRole: 'Durante o Ecocycle Planning (Mecanismo inclusivo para posicionar itens no mapa)',
    stringSequence: 'Ecocycle Planning articulado via 1-2-4-All',
    ...
    ecocyclePhase: 'Mapeamento de todos os quadrantes do Ecociclo',
    explanation: '1-2-4-All (#1) é uma escolha especialmente aderente para incorporar à String do Ecocycle. Ela garante que todas as vozes contribuam com profundidade antes de colar os post-its no diagrama.'
  },
  ...
  // Desafio 6
  {
    ...
    scenario: 'Antes de pedir que a equipe decida quais produtos e iniciativas devem ser mantidos ou descontinuados no Ecocycle Planning, você percebe que os líderes discordam sobre a razão de existir da organização. Qual estrutura deve preceder o Ecociclo na String, cavando o porquê essencial da equipe através de perguntas sucessivas em pares?',
    correctSkillIds: [3], // 3: 9 Whys
    incorrectSkillIds: [10, 15, 20, 24, 30],
    bestChoiceName: '9 Whys (9 Porquês)',
    ...
    stringSequence: '9 Whys ➔ Ecocycle Planning',
    anotherPossibility: 'Purpose to Practice (#33) pode complementar caso a equipe precise desdobrar o propósito descoberto em princípios e estruturas organizacionais.',
  ...
  // Desafio 7
  {
    ...
    bestChoiceName: 'Min Specs (Especificações Mínimas)',
    ...
    inStringRole: 'Depois do Ecocycle Planning (Intervenção na Armadilha da Rigidez)',
    stringSequence: 'Ecocycle Planning ➔ Min Specs',
    ...
    explanation: 'Min Specs (#19) atua de forma muito eficaz para destravar a Armadilha da Rigidez no Ecocycle. Ao definir apenas o estritamente obrigatório, devolve autonomia e flexibilidade às equipes.'
  },
  ...
  // Desafio 8
  {
    ...
    inStringRole: 'Depois do Ecocycle Planning (Aconselhamento prático entre pares)',
    stringSequence: 'Ecocycle Planning ➔ Troika Consulting',
  ...
  // Desafio 9
  {
    ...
    inStringRole: 'Depois do Ecocycle Planning (Nutrição do quadrante de Gestação)',
    stringSequence: 'Ecocycle Planning ➔ 25/10 Crowdsourcing',
  ...
  // Desafio 10
  {
    ...
    scenario: 'O Ecocycle mostrou que os novos projetos só vão avançar se a área de TI e a área Comercial cooperarem, mas elas vivem em atrito e promessas vagas. Qual estrutura na String força cada grupo a declarar pedidos diretos e receber respostas transparentes e inequívocas de "Sim", "Não", "Vou Tentar" ou "Esclarecimento"?',
    correctSkillIds: [30], // 30: What I Need From You (WINFY)
    incorrectSkillIds: [4, 15, 20, 24, 32],
    bestChoiceName: 'What I Need From You - WINFY (O Que Preciso de Você)',
    ...
    inStringRole: 'Depois do Ecocycle Planning (Pactuação de dependências interdepartamentais)',
    stringSequence: 'Ecocycle Planning ➔ What I Need From You (WINFY)',
    ...
    explanation: 'What I Need From You (#30) desata bloqueios relacionais entre áreas que retêm projetos na Armadilha da Escassez do Ecocycle, substituindo reuniões evasivas por acordos de serviço claros.'
  },
  ...
  // Desafio 11
  {
    ...
    scenario: 'Um departamento de operações está sufocado por rotinas antigas. Para facilitar um Ecocycle Planning libertador, você precisa: (1) antes do Ecociclo, provocar a equipe a rir e desapegar de seus hábitos e processos contraproducentes, e (2) logo após o mapeamento do Ecociclo, fazer com que cada um assuma compromissos imediatos com o que tem autonomia para executar. Quais 2 estruturas formam essa String com o Ecocycle?',
    correctSkillIds: [8, 5], // 8: TRIZ + 5: 15% Solutions
    incorrectSkillIds: [2, 14, 21, 31],
    bestChoiceName: 'TRIZ (#8) e 15% Solutions (#5)',
    whyItWorks: 'TRIZ limpa a mente e o portfólio de práticas disfuncionais antes do mapeamento, e 15% Solutions transforma a lucidez do Ecociclo em compromissos concretos que não dependem de autorização superior.',
    scenarioClue: '“antes do Ecociclo, provocar a equipe a rir e desapegar de hábitos contraproducentes... e logo após o mapeamento, fazer com que cada um assuma compromissos com o que tem autonomia”',
    inStringRole: 'TRIZ (Antes do Ecocycle) ➔ Ecocycle Planning (Durante) ➔ 15% Solutions (Depois)',
    stringSequence: 'TRIZ (#8) ➔ Ecocycle Planning (#12) ➔ 15% Solutions (#5)',
    anotherPossibility: 'Min Specs (#19) poderia ser inserido entre o Ecociclo e as 15% Solutions para podar regras antes dos planos individuais.',
  ...
  // Desafio 12
  {
    ...
    bestChoiceName: '9 Whys (#3) e What, So What, Now What? (#11)',
    whyItWorks: '9 Whys ancora as decisões do Ecocycle em um referencial claro de propósito, enquanto W3 fecha o processo extraindo significados compartilhados e decisões práticas sem precipitações.',
    ...
    inStringRole: '9 Whys (Antes do Ecocycle) ➔ Ecocycle Planning (Durante) ➔ W3 (Depois)',
    stringSequence: '9 Whys (#3) ➔ Ecocycle Planning (#12) ➔ What, So What, Now What? (#11)',
    ...
    explanation: '9 Whys (#3) ajuda o grupo a aprofundar seu propósito antes do Ecocycle Planning, e What, So What, Now What? (#11) traduz a visão do mapa em decisões lúcidas e planos executáveis.'
  },
  ...
  // Desafio 13
  {
    ...
    inStringRole: 'Ecocycle Planning ➔ 15% Solutions (Depois 1) ➔ Troika Consulting (Depois 2)',
    stringSequence: 'Ecocycle Planning (#12) ➔ 15% Solutions (#5) ➔ Troika Consulting (#6)',
  ...
  // Desafio 14
  {
    ...
    explanation: 'Min Specs (#19) atua na poda de restrições desnecessárias da Rigidez, enquanto WINFY (#30) remove o gargalo de cooperação entre áreas que impedia projetos de decolarem.'
  },
  ...
  // Desafio 15
  {
    ...
    inStringRole: 'Ecocycle Planning ➔ 25/10 Crowdsourcing (Geração de ideias) ➔ Purpose to Practice (Estruturação)',
    stringSequence: 'Ecocycle Planning (#12) ➔ 25/10 Crowdsourcing (#13) ➔ Purpose to Practice (#33)',
    anotherPossibility: '1-2-4-All (#1) pode anteceder o 25/10 para amadurecer as perguntas provocadoras sobre o futuro.',
    ecocyclePhase: 'Renovação e Gestação',
    explanation: '25/10 Crowdsourcing (#13) semeia propostas ousadas na Renovação do Ecocycle, e Purpose to Practice (#33) traduz a aposta principal em governança e modelo de operação claros.'
  },
  ...
  // Desafio 16
  {
    ...
    scenario: 'O desfecho da Destruição Criativa no Ecocycle determinou a descontinuidade de uma unidade de negócios histórica, gerando clima pesado e ressentimento. Para acolher o fator humano na String de facilitação, você precisa: (1) criar um espaço de escuta empática em pares sobre experiências de não ser ouvido, e (2) abrir um espaço calmo e circular com bastão da fala para conversar serenamente sobre a transição. Quais 2 estruturas compõem essa String de acolhimento?',
    correctSkillIds: [23, 14], // 23: Heard, Seen, Respected + 14: Conversation Café
    incorrectSkillIds: [9, 10, 22, 29],
    bestChoiceName: 'Heard, Seen, Respected (#23) e Conversation Café (#14)',
    whyItWorks: 'HSR reconstrói a empatia e validação emocional individual em pares, e Conversation Café oferece um ambiente seguro e desacelerado com bastão da fala para dialogar sobre perdas sem debate agressivo.',
    ...
    inStringRole: 'Ecocycle Planning ➔ Heard, Seen, Respected (Empatia) ➔ Conversation Café (Diálogo seguro)',
    stringSequence: 'Ecocycle Planning (#12) ➔ Heard, Seen, Respected (#23) ➔ Conversation Café (#14)',
    ...
    explanation: 'Heard, Seen, Respected (#23) e Conversation Café (#14) criam a segurança psicológica necessária para que o grupo processe as consequências humanas da Destruição Criativa sem cair no cinismo.'
  },
  ...
  // Desafio 17
  {
    ...
    scenario: 'Para facilitar uma transição estratégica de portfólio no Ecocycle Planning com 50 líderes, sua String prevê: (1) abrir a sessão conectando todos rapidamente e alinhando expectativas em 3 rodadas em pares, e (2) após posicionar os projetos no Ecociclo, desenhar a teia de relações organizacionais para identificar onde criar pontes entre departamentos necessárias para viabilizar as mudanças. Quais 2 estruturas completam essa String?',
    ...
    whyItWorks: 'Impromptu Networking aquece o grupo e gera entrosamento horizontal, enquanto Social Network Webbing mapeia as conexões informais e pontes que faltam para mobilizar recursos entre as fases do Ecociclo.',
    ...
    inStringRole: 'Impromptu Networking (Antes do Ecocycle) ➔ Ecocycle Planning ➔ Social Network Webbing (Depois)',
    stringSequence: 'Impromptu Networking (#2) ➔ Ecocycle Planning (#12) ➔ Social Network Webbing (#17)',
    anotherPossibility: 'WINFY (#30) pode fechar a String para formalizar pedidos nas pontes descobertas pelo mapeamento de rede.',
    ecocyclePhase: 'Conexão sistêmica e fluxo de recursos',
    explanation: 'Impromptu Networking (#2) estabelece a presença e abertura relacional na abertura, e Social Network Webbing (#17) materializa as vias de conexão informal necessárias para sustentar as transições do Ecocycle.'
  },
  ...
  // Desafio 18
  {
    ...
    inStringRole: 'Wicked Questions (Antes do Ecocycle ou Durante) ➔ Ecocycle Planning ➔ Integrated~Autonomy (Depois)',
  ...
  // Desafio 19
  {
    ...
    bestChoiceName: 'Simple Ethnography (#28) e UX Fishbowl (#15)',
    whyItWorks: 'A etnografia direta colhe evidências comportamentais sem distorções de pesquisas formais, e o UX Fishbowl permite que a equipe escute as experiências e dores reais dos clientes de forma vívida.',
    ...
    inStringRole: 'Simple Ethnography (Coleta no campo) ➔ UX Fishbowl (Escuta em grupo) ➔ Ecocycle Planning (Diagnóstico)',
    stringSequence: 'Simple Ethnography (#28) ➔ UX Fishbowl (#15) ➔ Ecocycle Planning (#12)',
    anotherPossibility: 'What, So What, Now What? (#11) pode fechar a rodada de observação para consolidar os insights antes de entrar no Ecociclo.',
    ecocyclePhase: 'Diagnóstico da fase de Maturidade',
    explanation: 'Simple Ethnography (#28) e UX Fishbowl (#15) alimentam o Ecocycle Planning com dados de experiência do usuário legítimos, evitando que o posicionamento dos itens seja baseado em opiniões subjetivas de gabinete.'
  },
  ...
  // Desafio 20
  {
    ...
    inStringRole: 'Ecocycle Planning ➔ Critical Uncertainties (Teste de estresse) ➔ Design Storyboards (Plano de ação visual)',
    stringSequence: 'Ecocycle Planning (#12) ➔ Critical Uncertainties (#32) ➔ Design Storyboards (#21)',
    anotherPossibility: '15% Solutions (#5) pode acompanhar o storyboard para definir quem assume a responsabilidade pelas ações dos primeiros quadros.',
    ecocyclePhase: 'Teste de resiliência e planejamento de transições',
    explanation: 'Critical Uncertainties (#32) testa a robustez das iniciativas mapeadas no Ecocycle frente a surpresas externas, e Design Storyboards (#21) ancora as decisões em um roadmap visual compartilhado.'
  },
  ...
  // Desafio 21
  {
    ...
    scenario: 'Você foi contratado para desenhar uma convenção de 1 dia com 120 participantes para destravar uma organização estagnada. A arquitetura de facilitação em torno do Ecocycle Planning deve: (1) abrir a sessão quebrando práticas disfuncionais com humor reflexivo, (2) utilizar a estrutura inclusiva universal para que todos processem e posicionem os post-its no Ecociclo sem monopolização de fala, e (3) encerrar o dia desafiando cada participante a firmar ações imediatas dentro de sua autonomia individual. Quais 3 estruturas complementam o Ecocycle?',
    ...
    anotherPossibility: 'W3 (#11) poderia ser intercalado antes das 15% Solutions se a liderança exigir um debriefing analítico intermediário.',
    ecocyclePhase: 'Ciclo completo: Desapego ➔ Mapeamento ➔ Ação Autônoma',
    explanation: 'Esta sequência combina três forças de facilitação de grande coerência pedagógica: TRIZ desconstrói a resistência da Rigidez, 1-2-4-All viabiliza o mapeamento coletivo no Ecocycle, e 15% Solutions ativa a execução sem dependências hierárquicas.'
  },
  ...
  // Desafio 22
  {
    ...
    scenario: 'Após uma dolorosa reestruturação organizacional, a equipe remanescente precisa reencontrar seu rumo. A jornada ao redor do Ecocycle Planning deve: (1) abrir resgatando histórias em que o time operou em seu auge para reconstruir autoconfiança, (2) debriefar o mapa do Ecociclo em 3 etapas metódicas (O quê? E daí? E agora?), e (3) mobilizar primeiros passos acionáveis na margem individual de autonomia de cada membro. Quais 3 estruturas compõem essa jornada com o Ecocycle?',
    correctSkillIds: [16, 11, 5], // 16: Appreciative Interviews + 11: W3 + 5: 15% Solutions
    incorrectSkillIds: [20, 27, 30],
    bestChoiceName: 'Appreciative Interviews (#16), W3 (#11) e 15% Solutions (#5)',
    whyItWorks: 'Appreciative Interviews transforma a energia coletiva do medo para o potencial a partir de memórias de sucesso real; W3 traduz o mapa do Ecociclo em interpretações sóbrias; e 15% Solutions canaliza essa energia em passos que os colaboradores controlam diretamente.',
    ...
    inStringRole: 'Appreciative Interviews (Abertura apreciativa) ➔ Ecocycle Planning ➔ W3 (Reflexão) ➔ 15% Solutions (Ação)',
    stringSequence: 'Appreciative Interviews (#16) ➔ Ecocycle Planning (#12) ➔ W3 (#11) ➔ 15% Solutions (#5)',
    anotherPossibility: 'Conversation Café (#14) poderia anteceder o W3 caso o luto ainda exija desabafo emocional antes da análise de fatos.',
    ecocyclePhase: 'Renovação e Travessia da Destruição Criativa',
    explanation: 'Appreciative Interviews (#16) restaura a confiança psicológica, o Ecocycle Planning situa a realidade do portfólio, W3 (#11) constrói sentido coletivo e 15% Solutions (#5) sela o compromisso de reconstrução.'
  },
  ...
  // Desafio 23
  {
    ...
    scenario: 'Durante o Ecocycle Planning, ficou evidente que a empresa tem gargalos tanto na Rigidez (por regulamentos obsoletos) quanto na Escassez (por desarticulação entre áreas e líderes inseguros). Para desenhar a intervenção pós-Ecociclo na String, você precisa: (1) podar as regras ao mínimo essencial, (2) formalizar pedidos diretos e respostas categóricas entre diretorias, e (3) organizar os donos de projetos em trios de consultoria rápida de 10 minutos. Quais 3 estruturas formam essa sequência?',
    correctSkillIds: [19, 30, 6], // 19: Min Specs + 30: WINFY + 6: Troika Consulting
    incorrectSkillIds: [2, 13, 24],
    bestChoiceName: 'Min Specs (#19), What I Need From You (#30) e Troika Consulting (#6)',
    whyItWorks: 'Min Specs desobstrui a Rigidez cortando regulamentos inflados; WINFY resolve o impasse interdepartamental da Escassez garantindo suporte explícito; e Troika capacita os líderes no refinamento de seus planos de ação.',
    ...
    inStringRole: 'Ecocycle Planning ➔ Min Specs (Podando Rigidez) ➔ WINFY (Pactuando Escassez) ➔ Troika (Mentoria entre pares)',
    stringSequence: 'Ecocycle Planning (#12) ➔ Min Specs (#19) ➔ WINFY (#30) ➔ Troika Consulting (#6)',
    anotherPossibility: '15% Solutions (#5) pode ser realizada antes da Troika para que cada líder traga sua proposta inicial pronta para receber conselho.',
    ecocyclePhase: 'Armadilha da Rigidez e Armadilha da Escassez',
    explanation: 'Esta combinação ataca os dois nós críticos do Ecociclo: Min Specs (#19) desengessa a governança interna, WINFY (#30) garante cooperação entre departamentos e Troika Consulting (#6) oferece mentoria prática imediata.'
  },
  ...
  // Desafio 24
  {
    ...
    scenario: 'O produto mais antigo da empresa foi enviado para a Destruição Criativa no Ecocycle Planning e agora precisa ser substituído por uma aposta inovadora. A String pós-Ecociclo deve: (1) formular a pergunta paradoxal entre estabilidade e disrupção, (2) gerar e ranquear democraticamente as 10 ideias mais ousadas com pontuação anônima rápida, e (3) estruturar a governança e práticas operacionais completas da nova aposta vencedora. Quais 3 estruturas compõem essa arquitetura?',
    correctSkillIds: [4, 13, 33], // 4: Wicked Questions + 13: 25/10 Crowdsourcing + 33: Purpose to Practice (P2P)
    incorrectSkillIds: [9, 18, 28],
    bestChoiceName: 'Wicked Questions (#4), 25/10 Crowdsourcing (#13) e Purpose to Practice (#33)',
    whyItWorks: 'Wicked Questions delimita a tensão estratégica inovadora; 25/10 extrai a imaginação coletiva e seleciona as melhores hipóteses; e Purpose to Practice constrói a disciplina institucional necessária para o nascimento do novo projeto.',
    ...
    inStringRole: 'Ecocycle Planning ➔ Wicked Questions (Enquadramento) ➔ 25/10 (Ideação) ➔ Purpose to Practice (Governança)',
    stringSequence: 'Ecocycle Planning (#12) ➔ Wicked Questions (#4) ➔ 25/10 Crowdsourcing (#13) ➔ Purpose to Practice (#33)',
    anotherPossibility: 'Design Storyboards (#21) pode ilustrar o plano cronológico de lançamento derivado do P2P.',
    ecocyclePhase: 'Destruição Criativa ➔ Renovação ➔ Nascimento',
    explanation: 'Wicked Questions (#4) desafia o pensamento convencional, 25/10 Crowdsourcing (#13) traz ideias ousadas na Renovação, e Purpose to Practice (#33) estabelece as bases sólidas para a nova aposta emergir com governança clara.'
  },
  ...
  // Desafio 25
  {
    ...
    anotherPossibility: 'Social Network Webbing (#17) pode mapear os laços informais entre os hospitais regionais antes do Shift & Share.',
  ...
  // Desafio 26
  {
    ...
    bestChoiceName: 'Impromptu Networking (#2), Open Space Technology (#31) e W3 (#11)',
    whyItWorks: 'Impromptu Networking inicia o encontro com alta energia e conexão relacional; Open Space Technology transfere a liderança e responsabilidade aos próprios participantes para trabalhar os temas quentes do Ecociclo; e W3 ancora as conclusões em compromissos práticos.',
    ...
    inStringRole: 'Impromptu Networking (Abertura) ➔ Ecocycle Planning ➔ Open Space Technology (Aprofundamento) ➔ W3 (Fechamento)',
    stringSequence: 'Impromptu Networking (#2) ➔ Ecocycle Planning (#12) ➔ Open Space Technology (#31) ➔ What, So What, Now What? (#11)',
    anotherPossibility: '25/10 Crowdsourcing (#13) poderia alimentar a abertura do Open Space com ideias ousadas.',
    ecocyclePhase: 'Mobilização em larga escala / Governança emergente',
    explanation: 'Impromptu Networking (#2) constrói a sintonia relacional de partida, Open Space Technology (#31) ativa a auto-organização e paixão dos líderes sobre os dilemas do Ecociclo, e W3 (#11) sintetiza os planos em decisões conjuntas.'
  },
  ...
  // Desafio 27
  {
    ...
    inStringRole: 'Ecocycle Planning ➔ Improv Prototyping (Simulação humana) ➔ Integrated~Autonomy (Governança) ➔ Design Storyboards (Roadmap)',
    stringSequence: 'Ecocycle Planning (#12) ➔ Improv Prototyping (#20) ➔ Integrated~Autonomy (#29) ➔ Design Storyboards (#21)',
    anotherPossibility: 'UX Fishbowl (#15) poderia preceder o Improv Prototyping para coletar histórias reais dos usuários que serão encenadas.',
  ...
  // Desafio 28
  {
    ...
    bestChoiceName: 'Generative Relationships STAR (#26), Conversation Café (#14) e What I Need From You (#30)',
    whyItWorks: 'STAR traz objetividade analítica ao estado do relacionamento entre as áreas; Conversation Café desacelera reatividades e cultiva a escuta autêntica com o bastão da fala; e WINFY sela pactos operacionais explícitos de apoio mútuo.',
    ...
    inStringRole: 'Ecocycle Planning ➔ Generative Relationships STAR (Diagnóstico) ➔ Conversation Café (Escuta) ➔ WINFY (Acordos)',
    stringSequence: 'Ecocycle Planning (#12) ➔ Generative Relationships STAR (#26) ➔ Conversation Café (#14) ➔ WINFY (#30)',
    anotherPossibility: 'Heard, Seen, Respected (#23) poderia atuar como etapa de acolhimento inicial em pares antes do Conversation Café.',
    ecocyclePhase: 'Cura de atritos e destravamento da Armadilha da Escassez',
    explanation: 'Generative Relationships STAR (#26) diagnostica os vetores relacionais fragilizados, Conversation Café (#14) restabelece a confiança na fala, e WINFY (#30) fecha acordos de serviço categóricos.'
  },
  ...
  // Desafio 29
  {
    ...
    bestChoiceName: 'Carta Especial — 5 Design Elements (#25), Critical Uncertainties (#32) e Celebrity Interview (#22)',
    whyItWorks: 'A Carta Especial 5 Design Elements opera o metadesign consciente da intervenção estruturando cada momento; Celebrity Interview alinha a visão da presidência sem monólogos hierárquicos; e Critical Uncertainties submete o portfólio a futuros imprevisíveis.',
    ...
    inStringRole: 'Carta Especial 5 Design Elements (Metadesign) ➔ Celebrity Interview (Alinhamento) ➔ Ecocycle Planning ➔ Critical Uncertainties (Resiliência)',
    stringSequence: 'Carta Especial 5 Design Elements (#25) ➔ Celebrity Interview (#22) ➔ Ecocycle Planning (#12) ➔ Critical Uncertainties (#32)',
    anotherPossibility: 'Purpose to Practice (#33) pode ser utilizada caso o conselho precise desenhar um novo comitê estratégico derivado das incertezas.',
    ecocyclePhase: 'Metadesign, Governança e Resiliência Estratégica',
    explanation: 'A Carta Especial 5 Design Elements (#25) fornece o metadesign de facilitação para arquitetar a sessão, Celebrity Interview (#22) conecta a liderança com autenticidade, e Critical Uncertainties (#32) prepara o Ecociclo contra choques futuros.'
  },
  ...
  // Desafio 30
  {
    ...
    whyItWorks: '9 Whys orienta o portfólio na direção do propósito raiz da organização; DAD resgata a sabedoria prática da ponta operacional que já resolveu problemas difíceis; e 15% Solutions devolve o poder de ação a cada colaborador no presente.',
    ...
    inStringRole: '9 Whys (Propósito) ➔ Discovery & Action Dialogue (Práticas positivas) ➔ Ecocycle Planning ➔ 15% Solutions (Ação)',
    stringSequence: '9 Whys (#3) ➔ Discovery & Action Dialogue (#9) ➔ Ecocycle Planning (#12) ➔ 15% Solutions (#5)',
    anotherPossibility: 'Appreciative Interviews (#16) pode atuar em sinergia com o DAD para aprofundar histórias de superação.',
    ecocyclePhase: 'Propósito ➔ Descoberta de Soluções ➔ Ecociclo ➔ Autonomia',
    explanation: '9 Whys (#3) ancora a bússola de prioridades, Discovery & Action Dialogue (#9) mobiliza as soluções que a própria equipe já desenvolveu na prática, e 15% Solutions (#5) traduz essas descobertas em ações imediatas.'
  }
];
